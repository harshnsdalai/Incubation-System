<?php include "startup_register.php" ?>
...
<html>
	...
	<nav class="gtco-nav" role="navigation">
		...
		<header id="gtco-header" class="gtco-cover gtco-cover-xs gtco-inner" style="height:100px;" role="banner">
			<div>
		        <h1 class="text-center"><strong>Startup Registration</strong></h1>
			</div>
		</header>	
...
<br><br><br>
								...
								<input type="text" class="form-control" id="name" name='comp_name' required>
							</div>
              <div class="form-group">
								<label for="message">Idea*</label>
								<input name="" id="message" cols="30" rows="10" class="form-control" name='idea' required>
							</div>
              ...
              <div class="form-group">
								...
								<input type="text" class="form-control" id="email" name='number' required>
							</div>
              <div class="form-group">
								<label for="Number">DIPP Number (if registered )</label>
								<input type="text" class="form-control" id="email" name="dipp">
							</div>
							<div class="form-group">
								<label for="">Financial Support</label>
								<input type="text" class="form-control" id="email" name='financial' required>
							</div>
							<div class="form-group">
								<label for="">Man-Power Need</label>
								<input type="text" class="form-control" id="email" name='manpower' required>
							</div>
							<div class="form-group">
